...
const HALFLING_ALIADOS = (pj, cap) => [
  { nombre: "Roblerto (el árbol)", ST: 6, AG: 1, AV: 11, si: !pj.flags.ramonVendido && !pj.flags.fichastePorMortaigne },
...
const HALFLING = {
  ...
  capitulos: [
    ...
    { id: 3, titulo: "El escándalo del árbol", sub: "Cuando Roblerto se come lo que no debe", escenas: ["federacion", "quehacerConRamon", "sinArbol", "pipoAprovecha"] },
  ...
  escenas: {
    ...
    primerPartido: {
      ...
      opciones: [
        ...
        { txt: "Que Roblerto te lance a la zona de anotación como una bomba de mantequilla.", req: { flag: "amigoArbol", noflag: "ramonVendido" }, forzable: true, tirada: { stat: "ST", obj: 7, riesgo: true,
    ...
    derbiPringados: {
      ...
      opciones: [
        ...
        { txt: "Que Roblerto despeje la merienda de un manotazo y correr tú.", req: { flag: "amigoArbol", noflag: "ramonVendido" }, forzable: true, tirada: { stat: "ST", obj: 7, riesgo: true,
    ...
    quehacerConRamon: {
      ...
      opciones: [
        { txt: "Entrenarlo en serio. Con pasteles y mucha paciencia.", fx: { rel: { arbol: 2, equipo: 1 }, Voluntad: 1, flag: "ramonEntrenado" }, msg: "Meses de galletas y señales. Roblerto aprende a distinguir el balón del árbitro, casi. Pasa de acertar una de seis a una de cuatro, que en un hombre-árbol es un doctorado. El equipo empieza a creer en algo por primera vez." },
        { txt: "Dejarlo a su aire. Un árbol es un árbol.", fx: { Honor: 1, rel: { arbol: 1 }, flag: "ramonLibre" }, msg: "Decides que Roblerto es Roblerto y que quien quiera un árbol domesticado que se compre un bonsái. Sigue mirando mariposas y comiéndose lo que no debe, pero es feliz, y su felicidad, un día, cruzará la línea por accidente." },
    ...
    sinArbol: {
      ...
      texto: (pj) => `${pj.flags.ramonVendido ? "Sin Roblerto desde hace semanas, jugáis como lo que sois: once pasteles corriendo." : pj.flags.ramonEntrenado ? "Roblerto está sancionado un partido por lo del árbitro, así que hoy jugáis sin red, con él en la grada comiendo palomitas y mirándoos preocupado." : "Roblerto hoy mira una nube y no piensa bajar, así que estáis solos."} Enfrente, un equipo de no-muertos de segunda mano —los Cuervos Rotos— a los que les faltan piezas y no les sobra piedad. ${pj.flags.aguantasteEntero ? "Al menos ya sabéis aguantar de pie. Eso hoy vale oro." : ""} {marcador}. Un partido para halflings de verdad: sin trucos, sin árbol, sin excusas.`,
      opciones: [
...
const HALFLING_TRANSICIONES = {
  ...
  4: (pj) => `${pj.flags.ramonVendido ? "Sin Roblerto, que acabó de atracción en un circo de Tercera, jugáis como once pasteles corriendo. Pero al menos ya nadie os come al mediocampo." : pj.flags.ramonEscupe ? "Lo del árbol que se come árbitros y los escupe vivos os ha hecho famosos por el motivo equivocado, que en un halfling es el único motivo posible." : "Roblerto sigue con vosotros, con expediente abierto y todo, que es lo más cerca de una estrella que tendréis nunca."} La Comarca ya sabe tu nombre, y eso, en un sitio donde nadie se va, es peligroso: significa que alguien de fuera también lo ha oído.`,
...
const sinRoblerto = (pj) => !!(pj.flags && (pj.flags.ramonVendido || pj.flags.fichastePorMortaigne));
